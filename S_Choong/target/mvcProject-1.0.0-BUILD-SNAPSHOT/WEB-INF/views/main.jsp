			...
			<div class="container-fluid">
				...
				<div id="navbar" class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="#"><span class="glyphicon glyphicon-user"></span> 가입</a></li>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				...
				<div class="container">
					<div class="carousel-caption">
						<h1>우리 여행갈래?</h1>
						<p style="font-size: 16px"><strong style="color: yellowgreen">여자친구</strong>와 어디로 여행갈까 고민중이세요? 여기 공짜로 여행가세요!</p>
			...
			<div class="item">
              ...
              <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p> -->
						<p>
							<a class="btn btn-lg btn-primary" href="#" role="button">Choong!!!</a>
						</p>
					</div>
				</div>
			</div>
 ...
 -->
		...
		<div class="row featurette">
			...
			<div class="col-md-5 col-md-pull-7">
				<img class="featurette-image img-responsive center-block" src="/resources/image/Lamborghini_Centenario.jpg" alt="Lamborghini Centenario">
			</div>
		</div>
